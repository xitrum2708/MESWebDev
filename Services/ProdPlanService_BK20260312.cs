...
{
    public class ProdPlanService5 : IProdPlanService
    {
        ...
        public ProdPlanService5(AppDbContext con, IMapper mapper, IHttpContextAccessor hca, ITranslationService translation)
        {
            _con = con;
            _mapper = mapper;
        ...
        public async Task<string> SMTSaveProdPlan(ProdPlanViewModel ppv)
        {
            ...
            List<SMTProdPlanHdrModel> prodPlansHdr = ppv.SMTProdPlanDTOList.GroupBy(i => new {i.StartScheduleDate, i.Lotno, i.PCBKey })
