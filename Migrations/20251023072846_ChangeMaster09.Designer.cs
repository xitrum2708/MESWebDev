...
namespace MESWebDev.Migrations
{
    ...
    [Migration("20251023072846_ChangeMaster09")]
    partial class ChangeMaster09
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FunctionModelFunctionModel", b =>
                {
                    b.Property<int>("AvailableParentsId")
                        .HasColumnType("int");

                    b.Property<int>("ChildrenId")
                        .HasColumnType("int");

                    b.HasKey("AvailableParentsId", "ChildrenId");

                    b.HasIndex("ChildrenId");

                    b.ToTable("FunctionModelFunctionModel");
                });
            ...
            modelBuilder.Entity("FunctionModelFunctionModel", b =>
                {
                    b.HasOne("MESWebDev.Models.Master.FunctionModel", null)
                        .WithMany()
                        .HasForeignKey("AvailableParentsId")
            ...
            modelBuilder.Entity("MESWebDev.Models.Master.RoleFuncPmsModel", b =>
                {
                    ...
                    b.HasOne("MESWebDev.Models.Master.PmsActionModel", "PmsAction")
                        .WithMany()
                        .HasForeignKey("PmsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
